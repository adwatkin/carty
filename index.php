...
echo "<h2> Shopping Cart System</h2>";  # sets a h2 heading as a welcome

echo "<p class='content'> Boiler plate text about whatever scenario is </p>";

echo "<p class='content'> You have to be registered to login and shop </p>";
